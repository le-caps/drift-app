...
export const RiskEngineView: React.FC<RiskEngineViewProps> = ({
  ...
  // ---------- BUTTON STYLE ----------
  const saveBtnClasses = (saved: boolean) =>
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20 max-w-5xl mx-auto px-4 w-full">
      ...
      <section className="layer-panel p-6 rounded-xl bg-white dark:bg-zinc-900 space-y-10 border border-gray-200 dark:border-zinc-800">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-zinc-800">
          ...
          <div className="space-y-4">
            {(local.riskKeywords || []).map((kw, i) => (
              ...
              >
                <input
                  ...
                  className="flex-1 px-3 py-2 text-sm rounded-md border bg-white dark:bg-zinc-900"
                />
                ...
                <button
                  ...
                  className="text-xs px-3 py-1 rounded-md border text-gray-600 dark:text-gray-300"
                >
                  Remove
                </button>
              </div>
            ...
            <button
              onClick={addKeyword}
              className="px-4 py-2 text-sm rounded-md border text-gray-700 dark:text-gray-200"
            >
              + Add Keyword Rule
            </button>
          </div>
          ...
          {[
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded-md border mr-2 mb-2 ${
                  active
                    ? "bg-red-100 border-red-300 text-red-700 dark:bg-red-900/20"
                    : "bg-gray-50 border-gray-300 text-gray-600 dark:bg-zinc-800"
                }`}
              >
                {stage}
              </button>
        ...
        {/* RISK DISTRIBUTION */}
        <div className="pt-4 border-t border-gray-200 dark:border-zinc-800">
          <h3 className="text-base font-semibold">Live Risk Distribution</h3>
            ...
            {[
              ...
              <div key={r.label}>
                ...
                <div className="w-full h-2 bg-gray-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                  <div className={`h-2 ${r.color}`} style={{ width: `${pct(r.count)}%` }} />
                </div>
              </div>
            ))}
          </div>
