        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <div className="relative group">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 w-full sm:w-56 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-md text-sm placeholder-gray-400 dark:text-white shadow-sm focus:ring-brand-primary"
            />
          </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col gap-4">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      ...
                      <button
                        ...
                        className="text-base font-bold text-gray-900 dark:text-white hover:text-brand-primary transition-colors text-left"
                      >
                        {deal.name}
                      </button>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mt-2">
                    ...
                    <button
                      onClick={() => onSelectDeal(deal.id)}
                      className="btn-primary px-4 py-2 text-sm font-medium flex items-center justify-center gap-1.5 shrink-0 w-full sm:w-auto"
                    >
                      View Details
