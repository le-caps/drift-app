...
export const InsightsView: React.FC<InsightsViewProps> = ({ deals, onSelectDeal }) => {
  ...
  const StatCard = ({ title, value, sub, icon: Icon, iconColor }: any) => (
    <div className="layer-panel p-5 rounded-lg flex flex-col justify-between h-full">
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-24 max-w-7xl mx-auto px-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="layer-panel p-5 rounded-lg">
        ...
        <div className="layer-panel p-5 rounded-lg flex flex-col items-center">
        ...
        {/* Priority Focus List */}
        <div className="layer-panel p-5 rounded-lg flex flex-col">
          ...
          <div className="space-y-1 flex-1 overflow-y-auto max-h-[240px] pr-1 custom-scrollbar">
