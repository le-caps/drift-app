    ...
    <div>
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          className="flex-1 appearance-none h-2 rounded-full bg-gray-200 dark:bg-zinc-700 cursor-pointer 
        ...
        <div className="flex items-center gap-1">
          <input
            ...
            className="w-14 px-2 py-1 text-sm rounded-md border border-gray-300 dark:border-zinc-700 
